    ...
    <div class="min-h-screen admin-wrapper py-10">
        <div class="max-w-3xl mx-auto px-6">
            ...
            <div class="admin-card border rounded-3xl p-8 shadow-xl">
                ...
                <div class="mb-6">
                    <h3 class="text-2xl font-bold admin-title">Editar Platillo 📝</h3>
                    <p class="admin-subtitle text-sm mt-1">Modifica los detalles del producto seleccionado: <span
                            class="text-amber-500 font-semibold">{{ $producto->name }}</span></p>
                </div>
                ...
                <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <!-- SECCIÓN DE LA IMAGEN CON ALPINE.JS (Mantiene la previsualización del recurso actual) -->
                    <div class="usr-photo-section border rounded-2xl p-4 space-y-4"
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between usr-divider-bottom pb-3 gap-2">
                            <div>
                                ...
                                <p class="admin-subtitle text-[11px] mt-0.5">Modifica el recurso multimedia del platillo.</p>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-4 usr-preview-box p-4 rounded-xl border">
                            <!-- Miniatura de la imagen cargada o placeholder -->
                            <div class="w-20 h-20 rounded-xl overflow-hidden border flex-shrink-0 shadow-inner flex items-center justify-center text-xl"
                            ...
                            <div class="flex-1 w-full">
                                ...
                                <div x-show="tipoImagen === 'file'" x-transition>
                                    <p class="text-[11px] admin-subtitle mb-2">Sube un archivo nuevo solo si deseas reemplazar la imagen actual.</p>
                                ...
                                <div x-show="tipoImagen === 'url'" x-transition class="hidden" :class="{ 'hidden': tipoImagen !== 'url' }">
                                    <p class="text-[11px] admin-subtitle mb-2">Modifica o pega una nueva dirección URL para la imagen del producto.</p>
